...
@pytest.fixture
def sample_excel_blob_for_formulas():
    """
...
def test_parse_formulas(sample_excel_blob_for_formulas):
    """
    ...
    with open("tests/parsers/data/formula_documents.txt.txt", "w", encoding="utf-8") as f:
